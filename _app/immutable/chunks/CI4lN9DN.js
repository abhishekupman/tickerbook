...
ORDER BY date DESC;    
    `,oe={name:"market_breadth_weekly_aggression",async getSpecs(){const n=await w(C).bqCacheService.queryAndCache(ae);if("needsSignIn"in n&&n.needsSignIn)return{needsSignIn:!0};const o=n,e=B.arrayToObject(o.data,o.schema);return console.log("queryRes",e),{specs:[[{title:"Weekly Market Breadth Aggregation",spec:te(e)}],[{title:"PnF 3 percent Column Counts Over Time",spec:ne(e)}],[{title:"PnF 1 percent Column Counts Over Time",spec:ee(e)}]]}}};function se(s){const n={};for(const e of s)e.sector&&e.market_cap>0&&(n[e.industry]||(n[e.industry]=0),n[e.industry]+=e.market_cap);const o=Object.entries(n).map(([e,t])=>({industry:e,market_cap:t}));return ce(o)}function ce(s){const n=s.reduce((t,a)=>t+a.market_cap,0),o=[],e=[];for(const t of s)t.market_cap>0&&(o.push(t.industry||"Unknown"),e.push(t.market_cap/n*100));return{kind:"plot",data:{industry:o,percentage:e},mapping:{x:"industry",y:"percentage",fill:"industry"},ggtitle:{text:"Market Cap Share by industry (%)"},ggsize:{width:600,height:400},layers:[{geom:"bar",stat:"identity",position:"stack",mapping:{y:"percentage",fill:"industry"},width:1}],scales:[{aesthetic:"y",labels_format:".1f"}],data_meta:{series_annotations:[{type:"str",column:"industry"},{type:"float",column:"percentage"}]}}}const _e={name:"market_cap_by_industry",async getSpecs(){const n=await w(C).tickerDetailsDataProvider.getJsonObject();return"needsSignIn"in n?{needsSignIn:!0}:{specs:[[{title:"Market Cap by Industry",spec:se(n)}]]}}};function re(s){const n={};for(const e of s)e.sector&&e.market_cap>0&&(n[e.sector]||(n[e.sector]=0),n[e.sector]+=e.market_cap);const o=Object.entries(n).map(([e,t])=>({sector:e,market_cap:t}));return ie(o)}function ie(s){const n=s.reduce((t,a)=>t+a.market_cap,0),o=[],e=[];for(const t of s)t.market_cap>0&&(o.push(t.sector||"Unknown"),e.push(t.market_cap/n*100));return{kind:"plot",data:{sector:o,percentage:e},mapping:{},coord:{name:"polar",theta:"y"},ggtitle:{text:"Market Cap Share by Sector (%)"},ggsize:{width:600,height:400},layers:[{geom:"bar",stat:"identity",position:"stack",mapping:{y:"percentage",fill:"sector"},width:1}],scales:[{aesthetic:"y",labels_format:".1f"}],data_meta:{series_annotations:[{type:"str",column:"sector"},{type:"float",column:"percentage"}]}}}const ue={name:"market_cap_by_sector",async getSpecs(){const n=await w(C).tickerDetailsDataProvider.getJsonObject();return"needsSignIn"in n?{needsSignIn:!0}:(console.log("bigQueryData",n),{specs:[[{title:"Market Cap by Sector",spec:re(n)}]]})}},le={market_breadth_last_x_days:Zt,market_breadth_weekly_aggregation:oe,market_breadth_last_x_days_by_sector:zt,market_breadth_last_x_days_by_industry:Xt,market_cap_by_sector:ue,market_cap_by_industry:_e,market_breadth_by_filter:Nt};function pe(s){const n=le[s];if(!n)throw new Error(`Chart provider not found: ${s}`);return n}var me=f('<div class="title svelte-1ni0144"> </div>'),de=f('<div><!> <div class="content svelte-1ni0144"><!></div></div>');function fe(s,n){let o=A(n,"title",8,""),e=A(n,"scrollable",8,!1);var t=de(),a=k(t);{var c=l=>{var u=me(),m=k(u,!0);g(u),L(()=>H(m,o())),p(l,u)};O(a,l=>{o()&&l(c)})}var _=gt(a,2),r=k(_);Mt(r,n,"default",{}),g(_),g(t),L(()=>et(t,1,`panel ${e()?"scrollable":""}`,"svelte-1ni0144")),p(s,t)}var ye=f('<div style="height: 400px;"></div>');function be(s,n){Q(n,!1);let o=A(n,"spec",8),e=tt(),t;j(async()=>{t=await Dt.waitForLetsPlot(),o()&&i(e)&&t.buildPlotFromRawSpecs(o(),i(e),{width_mode:"fit",height_mode:"fit"})}),K();var a=ye();wt(a,c=>T(e,c),()=>i(e)),p(s,a),J()}var ve=f('<p class="text-gray-500 text-sm">Loading charts...</p>'),ge=f('<p class="text-yellow-500 text-sm">Please sign in to view this chart.</p>'),Se=f('<p class="text-red-600 text-sm"> </p>'),he=f('<div style="height: 400px; display: flex; align-items: center; justify-content: center;"><p class="text-gray-500 text-sm">Chart will load when in view...</p></div>'),xe=f("<div><!></div>"),ke=f('<div class="dashboard-row svelte-j4nvyq"></div>');function Ue(s,n){Q(n,!0);const[o,e]=It(),t=()=>At(C,"$authStore",o);let a=U(null),c=U(!0),_=U(null),r=U(!1),l=ht(()=>t().hasAccessToken);St(()=>{i(l)&&(i(_)||i(r))&&u()});async function u(){try{const y=await pe(n.providerName).getSpecs(n.options);"needsSignIn"in y&&y.needsSignIn?T(r,!0):(T(r,!1),T(a,y.specs.map(M=>M.map(h=>({...h,visible:!1}))),!0))}catch(d){T(_,"Failed to load chart specs."),console.error(d)}finally{T(c,!1)}}j(async()=>{await u()});function m(d){const y=new IntersectionObserver(P=>{P.forEach(M=>{M.isIntersecting&&(d.dispatchEvent(new CustomEvent("enterViewport")),y.unobserve(d))})},{rootMargin:"200px 0px 200px 0px"});return y.observe(d),{destroy(){y.unobserve(d)}}}var F=G(),at=V(F);{var ot=d=>{var y=ve();p(d,y)},st=(d,y)=>{{var P=h=>{var N=ge();p(h,N)},M=(h,N)=>{{var ct=I=>{var D=Se(),$=k(D,!0);g(D),L(()=>H($,i(_))),p(I,D)},_t=(I,D)=>{{var $=q=>{var z=G(),rt=V(z);Y(rt,17,()=>i(a),X,(it,ut)=>{var W=ke();Y(W,21,()=>i(ut),X,(lt,R,Oe)=>{fe(lt,{get title(){return i(R).title},children:(pt,we)=>{var E=xe(),mt=k(E);{var dt=x=>{be(x,{get spec(){return i(R).spec}})},ft=x=>{var yt=he();p(x,yt)};O(mt,x=>{i(R).visible?x(dt):x(ft,!1)})}g(E),Et(E,x=>m==null?void 0:m(x)),Z("enterViewport",E,()=>i(R).visible=!0),p(pt,E)},$$slots:{default:!0}})}),g(W),p(it,W)}),p(q,z)};O(I,q=>{i(a)&&q($)},D)}};O(h,I=>{i(_)?I(ct):I(_t,!1)},N)}};O(d,h=>{i(r)?h(P):h(M,!1)},y)}};O(at,d=>{i(c)?d(ot):d(st,!1)})}p(s,F),J(),e()}var Ce=f("<p>No ticker data available.</p>"),Te=f('<div class="popup-overlay svelte-8wp2eq"><div class="popup-content svelte-8wp2eq"><!></div></div>');function Le(s,n){Q(n,!1);const o=tt();let e=A(n,"rowData",8);const t=xt();function a(m){m.key==="Escape"&&t("close")}j(()=>{window.addEventListener("keydown",a)}),kt(()=>{window.removeEventListener("keydown",a)}),Ct(()=>Tt(e()),()=>{T(o,e()&&e().length>0?e()[0]:null)}),Ot(),K();var c=Te(),_=k(c),r=k(_);{var l=m=>{Ft(m,{get ticker(){return i(o)}})},u=m=>{var F=Ce();p(m,F)};O(r,m=>{i(o)?m(l):m(u,!1)})}g(_),g(c),p(s,c),J()}export{Le as F,Ue as L,Re as T};
